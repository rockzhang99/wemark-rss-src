...
class RSS:
    ...
    def generate_rss(self,rss_list: dict, title: str = "Mp-We-Rss", 
                    link: str = "https://github.com/wemark-rss/wemark-rss",
    ...
    def generate_by_template(self,rss_list: dict, template: str, title: str = "Mp-We-Rss",link: str = "https://github.com/wemark-rss/wemark-rss",description: str = "RSS频道",language: str = "zh-CN",image_url:str=""):
